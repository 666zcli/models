...
tf.app.flags.DEFINE_string('eval_dir', './Adam_finetune_bias_tuning_lr_0.00001_ti_150000_ellipse_weight_decay_0.015/cifar10_eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', './Adam_finetune_bias_tuning_lr_0.00001_ti_150000_ellipse_weight_decay_0.015/cifar10_train',
